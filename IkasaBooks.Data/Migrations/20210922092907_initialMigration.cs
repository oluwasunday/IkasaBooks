    ...
    public partial class initialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookTypeCategory", x => new { x.BookTypesId, x.CategoriesId });
                    table.ForeignKey(
                        name: "FK_BookTypeCategory_BookTypes_BookTypesId",
                        column: x => x.BookTypesId,
                        principalTable: "BookTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookTypeCategory_Categories_CategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingLevel = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookTypeCategory_CategoriesId",
                table: "BookTypeCategory",
                column: "CategoriesId");
